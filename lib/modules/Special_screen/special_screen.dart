      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text(widget.cat,style: TextStyle(color: myAmber,fontSize: 22),),
          ),
          body: ListView(
            ...
            children: cubit.map((e) => Padding(
              ...
              child: GestureDetector(
                onTap: (){
                  navigateTo(context, IntroducerSpecial(e.specTitle,e.id));
                },
                child: Card(
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(e.specTitle,softWrap: true,style: const TextStyle(fontSize: 20),),
                  ),
                ),
              ),
            ),).toList(),
