  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ConsCubitIntro,cons_StatesIntro>(
      listener: (context,state){
        ...
        final cubit=ConsCubitIntro.get(context).specIntro.where((element) => element.specailst!.specTitle==widget.spec);
          return SafeArea(
            child: Scaffold(
                ...
                headerSliverBuilder: (context, innerBoxIsScrolled) => [
                  ...
                  SliverSafeArea(
                    ...
                    sliver: SliverAppBar(
                      ...
                      pinned: true,
                      floating: true,
                      title:Text(widget.spec,style: TextStyle(fontSize: 22,color: myAmber)),
                      actions: [
                        IconButton(onPressed: (){}, icon: Icon(Icons.search,color: myAmber,)),
                      ],
                      centerTitle: true,
                      bottom: PreferredSize(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              const Text("نتائج البحث :",style: TextStyle(fontSize: 20),),
                                      ...
                                      children: [
                                        Expanded(
                                          ...
                                          child:e.introLogo==null
                                              ?const Image(image: ExactAssetImage("assets/logo.png"),height: 100,)
                                              :CachedNetworkImage(
                                            width: double.infinity,
                                            height:100,
                                            imageUrl:imgurl+e.introLogo!.url!,
                                            placeholder: (context, url) => const SpinKitCircle(color: Colors.green,),
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(e.typeIntroducer!,style: TextStyle(fontSize: 14,color:  e.typeIntroducer=="Company"?Colors.blue:Colors.green)),
                                              const SizedBox(height: 8,),
                                              Row(children: [
                          ...
                          if (state is Cons_Loading_Special_intro) ...[
                            Positioned(
                              ...
                              child: SizedBox(
                                ...
                                height: 80,
                                child: Center(
                                  child: CircularProgressIndicator(color:myAmber,),
                                ),
                              ),
                            )
                          ]
