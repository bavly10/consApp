                ...
                child: Column(
                  children: [
                    ...
                    CustomSwitch(
                        ...
                        selected: UserCubit.get(context).accepted,
                        onChange: (bool v) {
                          showDialog(
                              context: context,
                              builder: (context) {
                                return CustomPrivacyDialog(
                                  ...
                                  title: mytranslate(context, "privacy"),
                                  buttonText: mytranslate(context, "ok"),
                                  onPressed: () {
                                    if (UserCubit.get(context).isChecked) {
                                      UserCubit.get(context).changePrivacy(v);
                                      Navigator.pop(context);
                                    } else {
                                      My_CustomAlertDialog(
                                          context: context,
                                  ...
                                  isChecked: UserCubit.get(context).isChecked,
                      ...
                      child: Mybutton(
                          ...
                          onPress: () async {
                            ...
                            if (form.currentState!.validate()) {
                              if (UserCubit.get(context).accepted) {
                                if (cubit.result != null) {
                                  try {
