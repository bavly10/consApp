  ...
  Widget build(BuildContext context) {
    return cubit.posts!.isEmpty
      ...
      children: cubit.posts!.map((e) {
        ...
        String formattedDate =intl.DateFormat('yyyy-MM-dd – kk:mm').format(now).toString();
        return GestureDetector(
          onTap: (){
            navigateTo(context,  DetailsPost(e.content,formattedDate,e.imgPost,imgurl+cubit.introLogo!.url!,cubit.username));
          },
          child: Padding(
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: CircleAvatar(
                          backgroundImage: NetworkImage(imgurl+cubit.introLogo!.url!),
                          radius: 28,
                        ),
                      ),
                      Column(
                        ...
                        children: [
                          Text(cubit.username, style:TextStyle(fontWeight: FontWeight.bold,color: myAmber),),
                ...
                Padding(
                  ...
                  child: Text("${e.content}",
                    style:const TextStyle(fontSize: 18,),textDirection: TextDirection.rtl,),
                ),
