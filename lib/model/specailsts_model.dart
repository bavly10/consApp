...
List<Specailsts> specailstsFromJson(String str) => List<Specailsts>.from(json.decode(str).map((x) => Specailsts.fromJson(x)));

String specailstsToJson(List<Specailsts> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Specailsts {
  ...
  factory Specailsts.fromJson(Map<String, dynamic> json) => Specailsts(
    ...
    users: List<User_spec>.from(json["users"].map((x) => User_spec.fromJson(x))),
  );
...
class User_spec {
  ...
  factory User_spec.fromJson(Map<String, dynamic> json) => User_spec(
    ...
    introLogo: json["intro_logo"] == null ? null : CatImg.fromJson(json["intro_logo"]),
    introImg: List<CatImg>.from(json["intro_img"].map((x) => CatImg.fromJson(x))),
  );
